...
function language_strings() {
	...
	arr["ENGLISH",6]="Welcome to ValexFrags script v${airgeddon_version}"
	arr["SPANISH",6]="Bienvenid@ a ValexFrags  script v${airgeddon_version}"
	arr["FRENCH",6]="Bienvenue au script ValexFrags  v${airgeddon_version}"
	arr["CATALAN",6]="Benvingut a ValexFrags  script v${airgeddon_version}"
	arr["PORTUGUESE",6]="Bem-vindo ao script ValexFrags  v${airgeddon_version}"
	arr["RUSSIAN",6]="Добро пожаловать в скрипт ValexFrags  v${airgeddon_version}"
	arr["GREEK",6]="Καλωσήρθατε στο ValexFrags  v${airgeddon_version}"
	arr["ITALIAN",6]="Benvenuti a ValexFrags  script v${airgeddon_version}"
	arr["POLISH",6]="Witaj w skrypcie ValexFrags  v${airgeddon_version}"
	arr["GERMAN",6]="Willkommen bei ValexFrags  Skript v${airgeddon_version}"
	arr["TURKISH",6]="ValexFrags  yazılımına hoşgeldiniz v${airgeddon_version}"
	...
	arr["ENGLISH",11]="Exiting Alexander ( Hamidi )  script v${airgeddon_version} - See you soon! :)"
	arr["SPANISH",11]="Saliendo de Alexander ( Hamidi )  script v${airgeddon_version} - Nos vemos pronto! :)"
	arr["FRENCH",11]="Fermeture du script Alexander ( Hamidi )  v${airgeddon_version} - A bientôt! :)"
	arr["CATALAN",11]="Sortint de Alexander ( Hamidi )  script v${airgeddon_version} - Ens veiem aviat! :)"
	arr["PORTUGUESE",11]="Saindo do script Alexander ( Hamidi )  v${airgeddon_version} - Até breve! :)"
	arr["RUSSIAN",11]="Выход из скрипта Alexander ( Hamidi )  v${airgeddon_version} - До встречи! :)"
	arr["GREEK",11]="Κλείσιμο του Alexander ( Hamidi )  v${airgeddon_version} - Αντίο! :)"
	arr["ITALIAN",11]="Abbandonando Alexander ( Hamidi )  script v${airgeddon_version} - A presto! :)"
	arr["POLISH",11]="Wyjście z skryptu Alexander ( Hamidi )  v${airgeddon_version} - Do zobaczenia wkrótce! :)"
	arr["GERMAN",11]="Sie verlassen Alexander ( Hamidi )  Skript v${airgeddon_version} - Bis bald! :)"
	arr["TURKISH",11]="Alexander ( Hamidi )  yazılımından çıkış yapılıyor v${airgeddon_version} - Tekrar görüşürüz! :)"
	...
	arr["ENGLISH",73]="ValexFrags script v${airgeddon_version} developed by:"
	arr["SPANISH",73]="ValexFrags script v${airgeddon_version} programado por:"
	arr["FRENCH",73]="Le script ValexFrags v${airgeddon_version} a été programmé par:"
	arr["CATALAN",73]="ValexFrags script v${airgeddon_version} desenvolupat per:"
	arr["PORTUGUESE",73]="Script ValexFrags v${airgeddon_version} desenvolvido por:"
	arr["RUSSIAN",73]="скрипт ValexFrags v${airgeddon_version} создал:"
	arr["GREEK",73]="Το ValexFrags script v${airgeddon_version} προγραμματίστηκε από:"
	arr["ITALIAN",73]="ValexFrags script v${airgeddon_version} sviluppato da:"
	arr["POLISH",73]="Skrypt ValexFrags v${airgeddon_version} napisany przez:"
	arr["GERMAN",73]="ValexFrags Skript v${airgeddon_version} entwickelt von:"
	arr["TURKISH",73]="ValexFrags yazılımı v${airgeddon_version} geliştiricisi:"
	...
	arr["ENGLISH",101]="ValexFrags main menu"
	arr["SPANISH",101]="Menú principal ValexFrags"
	arr["FRENCH",101]="Menu principal d'ValexFrags"
	arr["CATALAN",101]="Menú principal ValexFrags"
	arr["PORTUGUESE",101]="Menu principal ValexFrags"
	arr["RUSSIAN",101]="Главное меню ValexFrags"
	arr["GREEK",101]="Αρχικό μενού ValexFrags"
	arr["ITALIAN",101]="Menú principale ValexFrags"
	arr["POLISH",101]="Menu główne ValexFrags"
	arr["GERMAN",101]="ValexFrags-Hauptmenü"
	arr["TURKISH",101]="ValexFrags ana menü"
	...
	arr["ENGLISH",163]="When ValexFrags requests you to enter a path to a file either to use a dictionary, a Handshake or anything else, did you know that you can drag and drop the file over the airgeddon window? In this way you don't have to type the path manually"
	arr["SPANISH",163]="Cuando ValexFrags solicita que introduzcas una ruta a un fichero ya sea para utilizar un diccionario, un Handshake o cualquier otra cosa, ¿sabías que puedes arrastrar y soltar el fichero sobre la ventana de airgeddon? Así no tendrás que escribir la ruta manualmente"
	arr["FRENCH",163]="Quand ValexFrags demande d'entrer un chemin d'accès vers un fichier soit pour utiliser un dictionnaire, un Handshake ou autre chose, saviez-vous que vous pouvez faire glisser le fichier sur la fenêtre airgeddon? Donc vous n'avez pas à taper la route manuellement"
	arr["CATALAN",163]="Quan ValexFrags sol·licita que introdueixis una ruta a un fitxer ja sigui per utilitzar un diccionari, un Handshake o qualsevol altra cosa, ¿saps que pots arrossegar i deixar anar el fitxer sobre la finestra de airgeddon? Així no hauràs d'escriure la ruta manualment"
	arr["PORTUGUESE",163]="Quando a ValexFrags solicita que você insira o caminho de: um dicionário, um Handshake ou qualquer outra coisa, você sabia que pode arrastar o arquivo para janela do airgeddon? Assim você não precisa digitar o caminho manualmente"
	arr["RUSSIAN",163]="Когда ValexFrags просит вас ввести путь до файла, будь то словарь, рукопожатие или что-то ещё, знаете ли вы, что можно захватить этот файл мышкой, перетащить и бросить этот файл прямо в окно airgeddon? Таким образом вам не придётся вводить путь до файла вручную"
	...
	arr["ITALIAN",163]="Quando ValexFrags chiede di introdurre il percorso di un file per utilizzare un dizionario, un Handshake o qualsiasi altra cosa, sapevi che puoi trascinare e rilasciare il file sulla finestra di airgeddon? Cosí non dovrai digitare manualmente il percorso"
	arr["POLISH",163]="Wiesz, że kiedy ValexFrags poprosi Cię o podanie ścieżki do pliku aby użyć słownika, pliku Handshake lub cokolwiek innego, możesz przeciągnąć i upuścić plik przez okno airgeddon? Nie musisz wpisywać scieżki ręcznie"
	arr["GERMAN",163]="Wenn ValexFrags Sie auffordert, einen Dateipfad einzugeben, um ein Wörterbuch, einen Handshake oder etwas anderes zu verwenden, wussten Sie, dass Sie die Datei per Drag & Drop auf das airgeddon-Fenster ziehen können? Sie müssen die Route nicht manuell schreiben"
	arr["TURKISH",163]="ValexFrags, bir sözlük, bir Handshake veya başka bir şey kullanmak için dosyaya bir yol girmenizi istediğinde, dosyayı ValexFrags penceresinin üzerine sürükleyip bırakabileceğinizi biliyor muydunuz? Bu şekilde yolu elle yazmanız gerekmez"
	...
	arr["ENGLISH",174]="It seems you have an unsupported by ValexFrags bettercap version. The last bettercap supported version is ${maximum_bettercap_supported_version}. If you want to get this attack working you should perform a downgrade of the package. For more information, see the Bettercap section of the Wiki: ${normal_color}${urlgithub_wiki}/Bettercap Tips"
	arr["SPANISH",174]="Parece que tienes una versión de bettercap no soportada por ValexFrags. La última versión soportada de bettercap es la ${maximum_bettercap_supported_version}. Si quieres realizar este ataque deberías hacer un downgrade del paquete. Para más información consulta la sección Bettercap del Wiki: ${normal_color}${urlgithub_wiki}/Bettercap Tips"
	arr["FRENCH",174]="Il semble que vous avez une version non supportée de bettercap par ValexFrags. La dernière version prise en charge par bettercap est ${maximum_bettercap_supported_version}. Si vous voulez que cette attaque fonctionne, vous devez effectuer une downgrade du paquet. Pour plus d'informations, consultez la section Bettercap de notre Wiki: ${normal_color}${urlgithub_wiki}/Bettercap Tips"
	arr["CATALAN",174]="Sembla que teniu una versió de bettercap no suportada per ValexFrags. L'última versió suportada de bettercap és ${maximum_bettercap_supported_version}. Si voleu que aquest atac funcioni, hauríeu de realitzar un downgrade del paquet. Per a més informació consulta la secció Bettercap del Wiki: ${normal_color}${urlgithub_wiki}/Bettercap Tips"
	arr["PORTUGUESE",174]="Sua versão do bettercap não é suportada pelo ValexFrags. A última versão suportada é ${maximum_bettercap_supported_version}. Se você quiser que este ataque funcione, você deve fazer um downgrade. Para mais informações consulte a seção Bettercap Wiki: ${normal_color}${urlgithub_wiki}/Bettercap Tips"
	arr["RUSSIAN",174]="Кажется, ваша версия bettercap не поддерживается ValexFrags. Последняя поддерживаемая версия bettercap ${maximum_bettercap_supported_version}. Если вы хотите, чтобы эта атака работала, вы должны понизить версию этого пакета. Для получения дополнительной информации см. раздел Bettercap в Wiki: ${normal_color}${urlgithub_wiki}/Bettercap Tips"
	arr["GREEK",174]="Φαίνεται πως η έκδοση του bettercap δεν υποστηρίζεται από το ValexFrags. Η παλαιότερη έκδοση του bettercap που υποστηρίζεται από το  ValexFrags είναι η ${maximum_bettercap_supported_version}. Αν θέλετε αυτή η επίθεση να επιτύχει, θα πρέπει να κάνετε υποβάθμιση (downgrade) του πακέτου. Για περισσότερες πληροφορίες, ανατρέξτε στην ενότητα Bettercap του Wiki: ${normal_color}${urlgithub_wiki}/Bettercap Tips"
	arr["ITALIAN",174]="Sembra che tu abbia una versione di bettercap non supportata da ValexFrags. L'ultima versione di bettercap supportata è ${maximum_bettercap_supported_version}. Se vuoi far funzionare questo attacco devi eseguire un downgrade del pacchetto. Per ulteriori informazioni consultare la sezione Bettercap della nostra Wiki: ${normal_color}${urlgithub_wiki}/Bettercap Tips"
	arr["POLISH",174]="Wygląda na to, że masz nieobsługiwaną przez ValexFrags wersję bettercap. Ostatnia obsługiwana wersja bettercap to ${maximum_bettercap_supported_version}. Jeśli chcesz, aby ten atak działał, musisz obniżyć wersje. Aby uzyskać więcej informacji, zobacz sekcję Bettercap Wiki: ${normal_color}${urlgithub_wiki}/Bettercap Tips"
	arr["GERMAN",174]="Anscheinend ist die benutzte bettercap version von ValexFrags nicht unterstützt. Die letzte unterstützte bettercap Version ist ${maximum_bettercap_supported_version}. Wenn Sie diesen Angriff beuntzen wollen, sollten Sie ein Downgrade des bettercap-Pakets durchführen. Weitere Informationen finden Sie im Abschnitt Bettercap des Wiki: ${normal_color}${urlgithub_wiki}/Bettercap Tips"
	arr["TURKISH",174]="ValexFrags bettercap sürümününüz desteklenmiyor gibi görünüyor. Son çıkan en iyi desteklenen sürüm ${maximum_bettercap_supported_version}. Bu saldırıyı gerçekleştirmek istiyorsanız, paketin bir sürümünün düşürülmesi gerekir. Daha fazla bilgi için, Wiki'nin Bettercap bölümüne bakın: ${normal_color}${urlgithub_wiki}/Bettercap Tips"
	...
	arr["ENGLISH",191]="${blue_color}ValexFrags can't find the directory path where you have BeEF installed. ${green_color}Do you want to enter it manually? ${normal_color}${visual_choice}"
	arr["SPANISH",191]="${blue_color}ValexFrags no ha podido encontrar la ruta del directorio donde tienes instalado BeEF. ${green_color}¿Quieres introducirla manualmente? ${normal_color}${visual_choice}"
	arr["FRENCH",191]="${blue_color}ValexFrags n'a pas trouvé le dossier qui contient BeEF. ${green_color}Voulez-vous l'indiquer manuellement? ${normal_color}${visual_choice}"
	arr["CATALAN",191]="${blue_color}ValexFrags no ha pogut trobar la ruta del directori on tens instal·lat BeEF. ${green_color}¿Vols introduir-la manualment? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",191]="${blue_color}O ValexFrags não conseguiu encontrar o diretório onde você instalou o BeEF. ${green_color}Você quer inseri-lo manualmente? ${normal_color}${visual_choice}"
	arr["RUSSIAN",191]="${blue_color}ValexFrags не может найти путь к каталогу, где вы установили BeEF. ${green_color}Вы хотите ввести его вручную? ${normal_color}${visual_choice}"
	arr["GREEK",191]="${blue_color}Το ValexFrags δεν μπορεί να βρει το μονοπάτι για τον κατάλογο όπου έχετε εγκαταστημένο το BeEF. ${green_color}Θέλετε να το εισάγετε χειροκίνητα; ${normal_color}${visual_choice}"
	arr["ITALIAN",191]="${blue_color}ValexFrags non ha potuto trovare il percorso della directory in cui è stato installato BeEF. ${green_color}Vuoi inserirlo manualmente? ${normal_color}${visual_choice}"
	arr["POLISH",191]="${blue_color}ValexFrags nie mógł znaleźć ścieżki, w której zainstalowano BeEF. ${green_color}Czy chcesz ją wprowadzić ręcznie? ${normal_color}${visual_choice}"
	arr["GERMAN",191]="${blue_color}ValexFrags konnte den Verzeichnispfad, in den BeEF installiert ist, nicht finden. ${green_color}Möchten Sie es manuell eingeben? ${normal_color}${visual_choice}"
	arr["TURKISH",191]="${blue_color}ValexFrags BeEF yazılımının kurulu olduğu dizini bulamadı. ${green_color}Elle girmek ister misiniz? ${normal_color}${visual_choice}"
	...
	arr["ENGLISH",213]="A new version of the script exists (v${ValexFrags_last_version}). It will be downloaded"
	arr["SPANISH",213]="Existe una nueva versión del script (v${ValexFrags_last_version}). Será descargada"
	arr["FRENCH",213]="Une nouvelle version du script est disponible (v${ValexFrags_last_version}). Lancement du téléchargement"
	arr["CATALAN",213]="Hi ha una nova versió dels script (v${ValexFrags_last_version}). Serà descarregada"
	arr["PORTUGUESE",213]="Existe uma nova versão do script (v${ValexFrags_last_version}). Download será iniciado"
	arr["RUSSIAN",213]="Существует новая версия скрипта (v${ValexFrags_last_version}). Она будет загружена"
	arr["GREEK",213]="Υπάρχει νεότερη έκδοση του script (v${ValexFrags_last_version}). Θα κατέβει"
	arr["ITALIAN",213]="Esiste una nuova versione dello script (v${ValexFrags_last_version}). Sarà scaricata"
	arr["POLISH",213]="Jest nowa wersja skryptu (v${ValexFrags_last_version}). Zostanie ona pobrana"
	arr["GERMAN",213]="Es gibt eine neue Version des Skripts (v${ValexFrags_last_version}). Sie wird automatisch heruntergeladet"
	arr["TURKISH",213]="Yazılımın yeni bir sürümü mevcut (v${ValexFrags_last_version}). İndirilecek"
	...
	arr["ENGLISH",223]="ValexFrags needs root permissions to work. Launch the script as root user or using \"sudo\""
	arr["SPANISH",223]="ValexFrags necesita permisos de root para funcionar. Lanza el script como usuario root o usando \"sudo\""
	arr["FRENCH",223]="ValexFrags a besoin de permissions root pour êtreexécuter. Lancez the script en tant que root ou en utilisant \"sudo\""
	arr["CATALAN",223]="ValexFrags necessita permisos de root per funcionar. Llança l'script com a usuari root o utilitza \"sudo\""
	arr["PORTUGUESE",223]="ValexFrags necessita de permissões root para funcionar. Execute o script como root ou usando \"sudo\""
	arr["RUSSIAN",223]="ValexFrags требует для работы прав root. Запустите скрипт как root пользователь или используйте \"sudo\""
	arr["GREEK",223]="Το ValexFrags χρειάζεται root δικαιώματα για να δουλέψει. Ανοίξτε το script ως χρήστης root ή χρησιμοποιήστε \"sudo\""
	arr["ITALIAN",223]="ValexFrags ha bisogno dei permessi di root per l'esecuzione. Lancia lo script come root o usando \"sudo\""
	arr["POLISH",223]="ValexFrags wymaga uprawnień root do pracy. Uruchom skrypt jako root lub użyj \"sudo\""
	arr["GERMAN",223]="ValexFrags benötigt root Berechtigungen um zu arbeiten. Starten Sie das Skript als root oder mit \"sudo\""
	arr["TURKISH",223]="ValexFrags'un çalışması için root izinlerine ihtiyacı var. Yazılımı root kullanıcısı olarak veya \"sudo\" kullanarak başlat"
	...
	arr["ENGLISH",301]="For enterprise attacks, if you already have the legitimate certificates of the target network and the password, you can use them. If you don't have them, you can use ValexFrags to generate some certificates with the same data and use them to make the attack more credible"
	arr["SPANISH",301]="Para los ataques enterprise, si tienes los certificados legítimos de la red objetivo y su contraseña, podrás utilizarlos. Si no los tienes, puedes generar con ValexFrags unos certificados con los mismos datos y utilizarlos para que el ataque sea más creíble"
	arr["FRENCH",301]="Pour les attaques d'entreprise, si vous disposez des certificats légitimes du réseau objetive et de le mot de passe, vous pouvez les utiliser. Si vous ne les avez pas, vous pouvez générer avec ValexFrags des certificats avec les mêmes données et les utiliser pour que l'attaque soit plus crédible"
	arr["CATALAN",301]="Per als atacs enterprise, si tens els certificats legítims de la xarxa objectiu i la contrasenya, podràs utilitzar-los. Si no els tens, pots generar amb ValexFrags uns certificats amb les mateixes dades i utilitzar-los per que l'atac sigui més creïble"
	arr["PORTUGUESE",301]="Para ataques corporativos, se você tiver os certificados legítimos da rede e sua senha, poderá usá-los. Se você não tiver, pode gerar os certificados com ValexFrags usando os mesmos dados tornando o ataque mais confiável"
	arr["RUSSIAN",301]="${pending_of_translation} Для корпоративных атак, если у вас есть действительные сертификаты целевой сети и ваш пароль, вы можете использовать их. Если у вас их нет, вы можете создать с помощью сертификатов ValexFrags те же данные и использовать их для повышения вероятности атаки"
	arr["GREEK",301]="Για enterprise επιθέσεις, εάν έχετε τα νόμιμα πιστοποιητικά του δικτύου προορισμού και τον κωδικό πρόσβασής σας, μπορείτε να τα χρησιμοποιήσετε. Αν δεν τα έχετε, μπορείτε να χρησιμοποιήσετε το ValexFrags για να δημιουργήσετε ορισμένα πιστοποιητικά με τα ίδια δεδομένα και να τα χρησιμοποιήσετε για να κάνετε την επίθεση πιο αξιόπιστη"
	arr["ITALIAN",301]="Per gli attacchi enterprise, se si dispone dei certificati legittimi della rete obiettivo e della sua password, è possibile utilizzarli. Se non li hai, puoi generareli con ValexFrags con gli stessi dati e usarli per rendere l'attacco più credibile"
	arr["POLISH",301]="${pending_of_translation} W przypadku ataków korporacyjnych, jeśli masz prawidłowe certyfikaty sieci docelowej i hasło, możesz ich użyć. Jeśli ich nie masz, możesz wygenerować za pomocą certyfikatów ValexFrags z tymi samymi danymi i wykorzystać je, aby atak był bardziej wiarygodny"
	arr["GERMAN",301]="Wenn Sie bei Unternehmensangriffen über die legitimen Zertifikate des Zielnetzwerks und Ihr Kennwort verfügen, können Sie diese verwenden. Wenn Sie diese nicht haben, können Sie mit ValexFrags-Zertifikaten mit denselben Daten erstellen und sie verwenden, um den Angriff glaubwürdiger zu machen"
	...
	arr["ENGLISH",413]="ValexFrags fixed the problem. Your BeEF is operational"
	arr["SPANISH",413]="ValexFrags ha solucionado el problema. Tu BeEF está operativo"
	arr["FRENCH",413]="ValexFrags a résolu le problème. BeEF est opérationnel"
	arr["CATALAN",413]="ValexFrags ha solucionat el problema. El teu BeEF està operatiu"
	arr["PORTUGUESE",413]="O ValexFrags corrigiu o problema. Seu BeEF está operacional"
	arr["RUSSIAN",413]="ValexFrags устранил проблему. Ваш BeEF находится в рабочем состоянии"
	arr["GREEK",413]="Το ValexFrags διόρθωσε το πρόβλημα. Το BeEF λειτουργεί κανονικά"
	arr["ITALIAN",413]="ValexFrags ha risolto il problema. Il tuo BeEF è operativo"
	arr["POLISH",413]="ValexFrags rozwiązał problem. Twoja BeEF działa"
	arr["GERMAN",413]="ValexFrags hat das Problem gelöst. Ihr BeEF ist betriebsbereit"
	arr["TURKISH",413]="ValexFrags sorunu çözdü. BeEF'in operasyonel"
	...
	arr["ENGLISH",420]="It has been detected that you are running ValexFrags inside a Docker container. During this attack hostapd is used to create a fake AP. This component often conflicts with network-manager. From inside the container, airgeddon can't handle it. If you have network-manager installed on your host machine, close it or kill the conflicting processes or you'll get an error. For more information, see the Docker section of the Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["SPANISH",420]="Se ha detectado que estás ejecutando ValexFrags en un contenedor de Docker. En este ataque se utiliza hostapd para crear un falso AP. Este componente suele dar conflicto con network-manager. Desde el contenedor, airgeddon no puede gestionarlo. Si tienes network-manager instalado en tu máquina host, ciérralo o mata los procesos en conflicto u obtendrás un error. Para más información consulta la sección Docker del Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["FRENCH",420]="Il a été détecté qu'ValexFrags a été lancé depuis un conteneur Docker. Cette attaque à besoin d'hostapd pour créer un Point d'Accès piège. Hostapd a tendance à entrer en conflit avec network-manager et airgeddon ne peut pas le gérer depuis le conteneur. Si network-manager est installé sur votre machine host, arrêtez ou tuez les processus conflictuels. Dans le cas contraire vous obtiendrez une erreur. Pour plus d'informations, consultez la section Docker de notre Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["CATALAN",420]="S'ha detectat que estàs executant ValexFrags en un contenidor de Docker. En aquest atac s'utilitza hostapd per crear un fals AP. Aquest component sol donar conflicte amb network-manager. Des del contenidor, airgeddon no pot gestionar-lo. Si tens network-manager instal·lat a la teua màquina host, tanca'l o mata els processos en conflicte u obtindràs un error. Per a més informació consulta la secció Docker del Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["PORTUGUESE",420]="Detectamos que você está executando ValexFrags em um contêiner Docker. Neste ataque é usado hostapd para criar um AP falso. Este componente tende a entrar em conflito com network-manager. A partir do contêiner o airgeddon não pode controlá-lo. Se você tem network-manager instalado em sua máquina host feche-o, mate os processos conflitantes ou você irá obter um erro. Para mais informações consulte a seção Docker Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["RUSSIAN",420]="Определено, что вы запускаете ValexFrags внутри контейнера Docker. Во время этой атаки для создания поддельной AP используется hostapd. Этот компонент часто конфликтует с network-manager. Изнутри контейнера airgeddon не может справиться с этим. Если на вашем хост-компьютере установлен network-manager, закройте его или уберите конфликтующие процессы, иначе вы получите сообщение об ошибке. Для получения дополнительной информации см. раздел Docker в Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["GREEK",420]="Εντοπίστηκε πως τρέχετε το ValexFrags μέσα σε Docker container. Κατά τη διάρκεια αυτής της επίθεσης χρησιμοποιείται το hostapd για να δημιουργήσει ψεύτικο AP. Η δημιουργία αυτού κάνει conflicts με τον network-manager. Το airgeddon δεν μπορεί να το χειριστεί μέσα από το container. Αν υπάρχει ο network-manager εγκατεστημένος στον host-υπολογιστή, κλείστε τον ή διακόψτε τις διεργασίες που κάνουν conflict αλλιώς θα υπάρξουν σφάλματα. Για περισσότερες πληροφορίες, ανατρέξτε στην ενότητα Docker του Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["ITALIAN",420]="È stato rilevato che si sta eseguendo ValexFrags in un contenitore Docker. In questo attacco viene utilizzato hostapd per creare un falso AP. Questo componente tende a creare un conflitto con il network-manager. Dal contenitore, airgeddon non può gestirlo. Se si dispone di network-manager installato sul computer host, chiuderlo o uccidere i processi in conflitto o ci sará un errore. Per ulteriori informazioni consultare la sezione Docker della nostra Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["POLISH",420]="Wykryto, że używasz ValexFrags w kontenerze Docker. W tym ataku hostapd służy do utworzenia fałszywego AP. Ten komponent często ma konflikt z network-manager. Z kontenera airgeddon nie może sobie z tym poradzić. Jeśli na komputerze hosta zainstalowano network-manager, zamknij lub zabij sprzeczne procesy lub otrzymasz błąd. Aby uzyskać więcej informacji, zobacz sekcję Docker Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["GERMAN",420]="Es wurde festgestellt, dass Sie ValexFrags in einem Docker-Container ausführen. Bei diesem Angriff wird mit hostapd ein falscher AP erstellt. Diese Komponente steht normalerweise im Konflikt mit dem network-manager. Aus dem Container kann airgeddon das nicht schaffen. Wenn Sie den network-manager auf Ihrem Host-Computer installiert haben, schließen Sie ihn oder beenden Sie die Prozesse im Konflikt oder Sie erhalten einen Fehler. Weitere Informationen finden Sie im Abschnitt Docker des Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["TURKISH",420]="Bir Docker konteynırı içinde ValexFrags çalıştırdığınız tespit edildi. Bu saldırı sırasında hostapd sahte bir AP oluşturmak için kullanılır. Bu bileşen genellikle ağ yöneticisi ile çakışır. Konteynırın içinden, hava hücresi bunu kaldıramaz. Ana makinenize ağ yöneticisi yüklüyse, kapat veya çakışan işlemleri durdurun veya bir hatayla karşılaşırsınız. Daha fazla bilgi için, Wiki'nin Docker bölümüne bakın: ${normal_color}${urlgithub_wiki}/Docker"
